<div class="option">	  
   <a href="javascript:void(0)" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','Admin\admin');?>').resetParams().load();">Admin</a>&nbsp;&nbsp;   	
   <a href="javascript:void(0)" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','Admin\attribute');?>').resetParams().load();">Attribute</a>&nbsp;&nbsp;
   <a href="javascript:void(0)" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','Admin\Brand');?>').resetParams().load();">Brand</a>&nbsp;&nbsp;
   <a href="javascript:void(0)" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','Admin\category');?>').resetParams().load();">Categories</a>&nbsp;&nbsp;  
   <a href="javascript:void(0)" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','Admin\cms');?>').resetParams().load();">CMSs</a>&nbsp;&nbsp;  
   <a href="javascript:void(0)" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','Admin\customer');?>').resetParams().load();">Customers</a>&nbsp;&nbsp;
